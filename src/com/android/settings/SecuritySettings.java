...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (KEY_UNLOCK_SET_OR_CHANGE.equals(key)) {
            ...
            if (!helper.launchConfirmationActivity(
                ...
                // If this returns false, it means no password confirmation is
                // required, so
                // go ahead and start improve.
                // Note: currently a backup is required for biometric_weak so
                // this code path
                // can't be reached, but is here in case things change in the
                // future
            ...
            if (isToggled(preference)) {
                ...
                // In this case the user has just unchecked the checkbox, but
                // this action requires
                // them to confirm their password. We need to re-check the
                // checkbox until
                ...
                if (!helper.launchConfirmationActivity(
                    ...
                    // If this returns false, it means no password confirmation
                    // is required, so
                    // go ahead and uncheck it here.
                    // Note: currently a backup is required for biometric_weak
                    // so this code path
                    // can't be reached, but is here in case things change in
                    // the future
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CONFIRM_EXISTING_FOR_BIOMETRIC_WEAK_IMPROVE_REQUEST &&
            ...
            final LockPatternUtils lockPatternUtils = mChooseLockSettingsHelper.utils();
            lockPatternUtils.setBiometricWeakLivelinessEnabled(false);
            // Setting the mBiometricWeakLiveliness checked value to false is
            // handled when onResume
            // is called by grabbing the value from lockPatternUtils. We can't
            // set it here
